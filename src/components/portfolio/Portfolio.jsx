...
const projectData = [
  {
    ...
    title: "Stay Quick",
    description:
      "Discover the number one stationery shopping app in your area. From notebooks to office supplies, get everything you need quickly and conveniently, right at your fingertips, with a seamless experience designed to make shopping easier than ever.",
    link: "https://www.behance.net/gallery/190465731/StayQuick",
  },
  {
    id: 2,
    image: card2,
